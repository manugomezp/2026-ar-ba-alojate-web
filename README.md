...
### Arquitectura de microservicios en Backend con Java y SpringBoot, usando Spring Cloud para la configuración de los microservicios y del Gateway y Eureka para el Service Discovery. 
